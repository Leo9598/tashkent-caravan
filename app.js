...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const menuData = [
    ...
    { id: 'al12', category: 'alcohol', price: 100, ru: { name: 'Коньяк Vardăr 5 (50 мл)', desc: 'Выдержка 5 лет • Цена за 50 мл', tag: 'Коньяк (50 мл)' }, ro: { name: 'Divin Vardăr 5 (50 ml)', desc: 'Divin maturat 5 ani • Preț pentru 50 ml', tag: 'Divin (50 ml)' }, en: { name: 'Cognac Vardăr 5 (50 ml)', desc: '5 Years Aged Cognac • Price per 50 ml shot', tag: 'Cognac (50 ml)' } },
    { id: 'al13', category: 'alcohol', price: 120, ru: { name: 'Коньяк Vardăr 10 (50 мл)', desc: 'Выдержка 10 лет • Цена за 50 мл', tag: 'Коньяк (50 мл)' }, ro: { name: 'Divin Vardăr 10 (50 ml)', desc: 'Divin maturat 10 ani • Preț pentru 50 ml', tag: 'Divin (50 ml)' }, en: { name: 'Cognac Vardăr 10 (50 ml)', desc: '10 Years Aged Cognac • Price per 50 ml shot', tag: 'Cognac (50 ml)' } },
