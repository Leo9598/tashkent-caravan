...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const menuData = [
    ...
    // 8. ДЕСЕРТЫ (desserts)
    { id: 'ds1', category: 'desserts', price: 80, ru: { name: 'Мороженое', desc: 'Ассорти сливочного мороженого с ягодным соусом', tag: 'Десерт' }, ro: { name: 'Înghețată', desc: 'Inghețată asortată cu sos de fructe de pădure', tag: 'Desert' }, en: { name: 'Ice Cream', desc: 'Assorted cream ice cream scoops with berry sauce', tag: 'Dessert' } },
    { id: 'ds2', category: 'desserts', price: 100, ru: { name: 'Баклава', desc: 'Традиционная восточная баклава с орехами и медовым сиропом', tag: 'Восток' }, ro: { name: 'Baclava', desc: 'Baclava tradițională orientală cu nuci și miere', tag: 'Oriental' }, en: { name: 'Baklava', desc: 'Authentic oriental sweet baklava with walnuts and honey', tag: 'Sweet' } },
    { id: 'ds3', category: 'desserts', price: 110, ru: { name: 'Наполеон', desc: 'Домашний торт Наполеон со заварным ванильным кремом', tag: 'Торт' }, ro: { name: 'Tort Napoleon', desc: 'Tort de casă Napoleon cu cremă fină de vanilie', tag: 'Tort' }, en: { name: 'Napoleon Cake', desc: 'Classic home-style flaky Napoleon cake with vanilla custard', tag: 'Cake' } },
    { id: 'ds4', category: 'desserts', price: 140, ru: { name: 'Малиновый штрудель', desc: 'Тёплый штрудель с сочной малиной и шариком мороженого', tag: 'Теплое' }, ro: { name: 'Ștrudel cu Zmeură', desc: 'Ștrudel cald cu zmeură suculentă și înghețată', tag: 'Cald' }, en: { name: 'Raspberry Strudel', desc: 'Warm raspberry strudel served with a scoop of vanilla ice cream', tag: 'Warm' } },
    ...
    { id: 'w3_g', category: 'alcohol', price: 90, ru: { name: 'Ice Wine Riesling — 1 бокал (150 мл)', desc: 'Десертное ледяное вино', tag: 'Десертное вино (150 мл)' }, ro: { name: 'Ice Wine Riesling — 1 pahar (150 ml)', desc: 'Vin dulce de desert', tag: 'Vin de desert (150 ml)' }, en: { name: 'Ice Wine Riesling — 1 Glass (150 ml)', desc: 'Dessert ice wine', tag: 'White Wine (150 ml)' } },
    ...
    { id: 'w6_g', category: 'alcohol', price: 80, ru: { name: 'Individo Fetească Regală / Riesling — 1 бокал (150 мл)', desc: 'Купажное белое сухое вино', tag: 'Белое вино (150 мл)' }, ro: { name: 'Individo Fetească Regală / Riesling — 1 pahar (150 ml)', desc: 'Vin alb sec cupaj', tag: 'Vin alb (150 ml)' }, en: { name: 'Individo Fetească Regală / Riesling — 1 Glass (150 ml)', desc: 'Blended dry white wine', tag: 'White Wine (150 ml)' } },
    ...
    { id: 'w7_g', category: 'alcohol', price: 80, ru: { name: 'Individo Traminer / Sauvignon Blanc — 1 бокал (150 мл)', desc: 'Ароматное белое сухое вино', tag: 'Белое вино (150 мл)' }, ro: { name: 'Individo Traminer / Sauvignon Blanc — 1 pahar (150 ml)', desc: 'Vin alb sec aromat', tag: 'Vin alb (150 ml)' }, en: { name: 'Individo Traminer / Sauvignon Blanc — 1 Glass (150 ml)', desc: 'Aromatic dry white wine', tag: 'White Wine (150 ml)' } },
    ...
    // РОЗОВЫЕ ВИНА
    { id: 'w9_g', category: 'alcohol', price: 80, ru: { name: 'Individo Malbec / Syrah Rosé — 1 бокал (150 мл)', desc: 'Розовое сухое вино', tag: 'Розовое вино (150 мл)' }, ro: { name: 'Individo Malbec / Syrah Rosé — 1 pahar (150 ml)', desc: 'Vin rosé sec', tag: 'Vin rosé (150 ml)' }, en: { name: 'Individo Malbec / Syrah Rosé — 1 Glass (150 ml)', desc: 'Dry rosé wine', tag: 'Rosé Wine (150 ml)' } },
    ...
    { id: 'w13_g', category: 'alcohol', price: 80, ru: { name: 'Individo Fetească Neagră — 1 бокал (150 мл)', desc: 'Красное сухое автохтонное вино', tag: 'Красное вино (150 мл)' }, ro: { name: 'Individo Fetească Neagră — 1 pahar (150 ml)', desc: 'Vin roșu sec din soi autohton', tag: 'Vin roșu (150 ml)' }, en: { name: 'Individo Fetească Neagră — 1 Glass (150 ml)', desc: 'Indigenous dry red wine', tag: 'Red Wine (150 ml)' } },
    ...
    { id: 'w14_g', category: 'alcohol', price: 80, ru: { name: 'Individo Malbec / Syrah — 1 бокал (150 мл)', desc: 'Купажное красное сухое вино', tag: 'Красное вино (150 мл)' }, ro: { name: 'Individo Malbec / Syrah — 1 pahar (150 ml)', desc: 'Vin roșu sec cupaj', tag: 'Vin roșu (150 ml)' }, en: { name: 'Individo Malbec / Syrah — 1 Glass (150 ml)', desc: 'Blended dry red wine', tag: 'Red Wine (150 ml)' } },
    ...
    { id: 'w15_g', category: 'alcohol', price: 130, ru: { name: 'Taraboste Pinot Noir — 1 бокал (150 мл)', desc: 'Премиальное коллекционное красное вино', tag: 'Премиум вино (150 мл)' }, ro: { name: 'Taraboste Pinot Noir — 1 pahar (150 ml)', desc: 'Vin roșu premium de colecție', tag: 'Vin Premium (150 ml)' }, en: { name: 'Taraboste Pinot Noir — 1 Glass (150 ml)', desc: 'Premium reserve red wine', tag: 'Premium Wine (150 ml)' } },
    ...
    // ИГРИСТЫЕ ВИНА
    { id: 'w16_g', category: 'alcohol', price: 90, ru: { name: 'Martelletti Prosecco — 1 бокал (150 мл)', desc: 'Итальянское игристое Просекко', tag: 'Игристое вино (150 мл)' }, ro: { name: 'Martelletti Prosecco — 1 pahar (150 ml)', desc: 'Vin spumant italian Prosecco', tag: 'Vin spumant (150 ml)' }, en: { name: 'Martelletti Prosecco — 1 Glass (150 ml)', desc: 'Italian Prosecco sparkling wine', tag: 'Sparkling Wine (150 ml)' } },
    ...
    { id: 'w17_g', category: 'alcohol', price: 90, ru: { name: 'Martelletti Asti — 1 бокал (150 мл)', desc: 'Итальянское сладкое игристое вино Асти', tag: 'Игристое вино (150 мл)' }, ro: { name: 'Martelletti Asti — 1 pahar (150 ml)', desc: 'Vin spumant dulce italian Asti', tag: 'Vin spumant (150 ml)' }, en: { name: 'Martelletti Asti — 1 Glass (150 ml)', desc: 'Italian sweet Asti sparkling wine', tag: 'Sparkling Wine (150 ml)' } },
    ...
    { id: 'w18_g', category: 'alcohol', price: 80, ru: { name: 'Inspiro Vartely Brut — 1 бокал (150 мл)', desc: 'Игристое вино брют', tag: 'Игристое вино (150 мл)' }, ro: { name: 'Inspiro Vartely Brut — 1 pahar (150 ml)', desc: 'Vin spumant brut', tag: 'Vin spumant (150 ml)' }, en: { name: 'Inspiro Vartely Brut — 1 Glass (150 ml)', desc: 'Brut sparkling wine', tag: 'Sparkling Wine (150 ml)' } },
