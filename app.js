...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const menuData = [
    ...
    { id: 'al12', category: 'alcohol', price: 100, ru: { name: 'Коньяк (Дивин) Bardar 5 лет (50 мл)', desc: 'Молдавский коньяк 5 лет выдержки', tag: 'Коньяк (50 мл)' }, ro: { name: 'Divin Bardar 5 ani (50 ml)', desc: 'Divin maturat 5 ani', tag: 'Divin (50 ml)' }, en: { name: 'Divin Bardar 5 Years Cognac (50 ml)', desc: '5 Years Aged Moldovan Cognac', tag: 'Cognac (50 ml)' } },
