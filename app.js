...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const menuData = [
    ...
    { id: 'b9', category: 'alcohol', price: 110, ru: { name: 'Апероль Сприц', desc: 'Игристый аперитив с нотами апельсина', tag: 'Коктейль' }, ro: { name: 'Aperol Spritz', desc: 'Cocktail spumant cu note de portocală', tag: 'Cocktail' }, en: { name: 'Aperol Spritz', desc: 'Classic sparkling cocktail with Aperol and Prosecco', tag: 'Cocktail' } },
    { id: 'b10', category: 'alcohol', price: 40, ru: { name: 'Вино белое (бокал)', desc: 'Изысканное сухое белое вино', tag: 'Вино' }, ro: { name: 'Vin Alb (pahar)', desc: 'Vin alb sec rafinat', tag: 'Vin' }, en: { name: 'White Wine (glass)', desc: 'Crisp dry white wine glass', tag: 'Wine' } },
    { id: 'b11', category: 'alcohol', price: 40, ru: { name: 'Вино красное (бокал)', desc: 'Насыщенное красное вино', tag: 'Вино' }, ro: { name: 'Vin Roșu (pahar)', desc: 'Vin roșu sec aromat', tag: 'Vin' }, en: { name: 'Red Wine (glass)', desc: 'Rich full-bodied red wine glass', tag: 'Wine' } },
