...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const menuData = [
    ...
    { id: 'st2', category: 'starters', price: 250, weight: 250, ru: { name: 'Сырное плато', desc: 'Ассорти отборных сыров', tag: 'Ассорти' }, ro: { name: 'Platou de Brânzeturi', desc: 'Asortiment de brânzeturi alese', tag: 'Asortat' }, en: { name: 'Cheese Platter', desc: 'Assortment of selected fine cheeses', tag: 'Platter' } },
    ...
    { id: 'st4', category: 'starters', price: 150, weight: 250, ru: { name: 'Овощное плато', desc: 'Ассорти свежих овощей и зелени', tag: 'Свежее' }, ro: { name: 'Platou de Legume', desc: 'Asortiment de legume proaspete', tag: 'Proaspăt' }, en: { name: 'Vegetable Platter', desc: 'Platter of crisp fresh garden vegetables', tag: 'Fresh' } },
    { id: 'st5', category: 'starters', price: 160, weight: 200, ru: { name: 'Соленья', desc: 'Ассорти домашних солений', tag: 'Домашнее' }, ro: { name: 'Murături de Casă', desc: 'Asortiment de murături de casă', tag: 'De Casă' }, en: { name: 'Home-style Pickles', desc: 'Assortment of house-made pickles', tag: 'Homemade' } },
    ...
    { id: 'sd3', category: 'sides', price: 110, weight: 120, ru: { name: 'Куриные наггетсы', desc: 'Сочные кусочки куриного филе в хрустящей панировке', tag: 'Гарнир' }, ro: { name: 'Nuggets de Pui', desc: 'Nuggets suculente de pui în crustă crocantă', tag: 'Garnitură' }, en: { name: 'Chicken Nuggets', desc: 'Crispy golden fried chicken nuggets', tag: 'Side' } },
