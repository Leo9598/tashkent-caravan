...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const menuData = [
    ...
    { id: 'b1', category: 'bar', price: 30, ru: { name: 'Эспрессо', desc: 'Бодрящий эспрессо двойной обжарки', tag: 'Кофе' }, ro: { name: 'Espresso', desc: 'Espresso clasic tare și aromat', tag: 'Creație' }, en: { name: 'Espresso', desc: 'Rich and bold single shot espresso', tag: 'Coffee' } },
