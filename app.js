...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const menuData = [
    ...
    { id: 'b9', category: 'alcohol', price: 110, image: 'images/hero.jpg', ru: { name: 'Апероль Сприц', desc: 'Игристый аперитив с нотами апельсина', tag: 'Коктейль' }, ro: { name: 'Aperol Spritz', desc: 'Cocktail spumant cu note de portocală', tag: 'Cocktail' }, en: { name: 'Aperol Spritz', desc: 'Classic sparkling cocktail with Aperol and Prosecco', tag: 'Cocktail' } },
    { id: 'b10', category: 'alcohol', price: 40, image: 'images/hero.jpg', ru: { name: 'Вино белое (бокал)', desc: 'Изысканное сухое белое вино', tag: 'Вино' }, ro: { name: 'Vin Alb (pahar)', desc: 'Vin alb sec rafinat', tag: 'Vin' }, en: { name: 'White Wine (glass)', desc: 'Crisp dry white wine glass', tag: 'Wine' } },
    { id: 'b11', category: 'alcohol', price: 40, image: 'images/hero.jpg', ru: { name: 'Вино красное (бокал)', desc: 'Насыщенное красное вино', tag: 'Вино' }, ro: { name: 'Vin Roșu (pahar)', desc: 'Vin roșu sec aromat', tag: 'Vin' }, en: { name: 'Red Wine (glass)', desc: 'Rich full-bodied red wine glass', tag: 'Wine' } },
    { id: 'b12', category: 'alcohol', price: 60, image: 'images/hero.jpg', ru: { name: 'Дунканы тёмное', desc: 'Тёмное бархатистое пиво', tag: 'Пиво' }, ro: { name: 'Bere Neagră Duncan', desc: 'Bere neagră cremoasă', tag: 'Bere' }, en: { name: 'Dunkel Dark Beer', desc: 'Rich velvet dark craft beer', tag: 'Beer' } },
    { id: 'b13', category: 'alcohol', price: 60, image: 'images/hero.jpg', ru: { name: 'Карлсберг', desc: 'Светлое лагерное пиво', tag: 'Пиво' }, ro: { name: 'Bere Carlsberg', desc: 'Bere blondă de calitate', tag: 'Bere' }, en: { name: 'Carlsberg Beer', desc: 'Premium blond lager beer', tag: 'Beer' } },
    { id: 'b14', category: 'alcohol', price: 40, image: 'images/hero.jpg', ru: { name: 'Львовское', desc: 'Освежающее светлое пиво', tag: 'Пиво' }, ro: { name: 'Bere Lvivske', desc: 'Bere blondă răcoritoare', tag: 'Bere' }, en: { name: 'Lvivske Beer', desc: 'Refreshing light pale beer', tag: 'Beer' } },

    // SHATEAU VARTELY WINES
    { id: 'w1', category: 'alcohol', price: 450, ru: { name: 'TARABOSTE Pinot Noir (0.75 л)', desc: 'Chateau Vartely • Сухое красное вино • 0.750 л', tag: 'Chateau Vartely' }, ro: { name: 'TARABOSTE Pinot Noir (0.75 L)', desc: 'Chateau Vartely • Vin roșu sec • 0.750 L', tag: 'Chateau Vartely' }, en: { name: 'TARABOSTE Pinot Noir (0.75 L)', desc: 'Chateau Vartely • Dry red wine • 0.750 L', tag: 'Chateau Vartely' } },
    { id: 'w2', category: 'alcohol', price: 400, ru: { name: 'TARABOSTE Chardonnay (0.75 л)', desc: 'Chateau Vartely • Сухое белое вино • 0.750 л', tag: 'Chateau Vartely' }, ro: { name: 'TARABOSTE Chardonnay (0.75 L)', desc: 'Chateau Vartely • Vin alb sec • 0.750 L', tag: 'Chateau Vartely' }, en: { name: 'TARABOSTE Chardonnay (0.75 L)', desc: 'Chateau Vartely • Dry white wine • 0.750 L', tag: 'Chateau Vartely' } },
    { id: 'w3', category: 'alcohol', price: 500, ru: { name: 'ICE WINE Riesling (0.375 л)', desc: 'Chateau Vartely • Десертное ледяное вино • 0.375 л', tag: 'Chateau Vartely' }, ro: { name: 'ICE WINE Riesling (0.375 L)', desc: 'Chateau Vartely • Vin dulce de desert • 0.375 L', tag: 'Chateau Vartely' }, en: { name: 'ICE WINE Riesling (0.375 L)', desc: 'Chateau Vartely • Dessert Ice Wine • 0.375 L', tag: 'Chateau Vartely' } },
    { id: 'w4', category: 'alcohol', price: 300, ru: { name: 'LATE HARVEST Sauvignon Blanc (0.5 л)', desc: 'Chateau Vartely • Десертное вино позднего сбора • 0.500 л', tag: 'Chateau Vartely' }, ro: { name: 'LATE HARVEST Sauvignon Blanc (0.5 L)', desc: 'Chateau Vartely • Vin dulce Late Harvest • 0.500 L', tag: 'Chateau Vartely' }, en: { name: 'LATE HARVEST Sauvignon Blanc (0.5 L)', desc: 'Chateau Vartely • Late Harvest dessert wine • 0.500 L', tag: 'Chateau Vartely' } },
    { id: 'w5', category: 'alcohol', price: 200, ru: { name: 'TOTEM Viorica (0.75 л)', desc: 'Chateau Vartely • Белое сухое вино • 0.750 л', tag: 'Chateau Vartely' }, ro: { name: 'TOTEM Viorica (0.75 L)', desc: 'Chateau Vartely • Vin alb sec • 0.750 L', tag: 'Chateau Vartely' }, en: { name: 'TOTEM Viorica (0.75 L)', desc: 'Chateau Vartely • Dry white wine • 0.750 L', tag: 'Chateau Vartely' } },
    { id: 'w6', category: 'alcohol', price: 200, ru: { name: 'PINOT GRIGIO Chateau Vartely (0.75 л)', desc: 'Chateau Vartely • Свежее белое сухое вино • 0.750 л', tag: 'Chateau Vartely' }, ro: { name: 'PINOT GRIGIO Chateau Vartely (0.75 L)', desc: 'Chateau Vartely • Vin alb sec • 0.750 L', tag: 'Chateau Vartely' }, en: { name: 'PINOT GRIGIO Chateau Vartely (0.75 L)', desc: 'Chateau Vartely • Fresh dry white wine • 0.750 L', tag: 'Chateau Vartely' } },

    // INDIVIDO RED
    { id: 'w7', category: 'alcohol', price: 250, ru: { name: 'INDIVIDO Saperavi (0.75 л)', desc: 'Chateau Vartely • Красное сухое вино Саперави • 0.750 л', tag: 'Individo Red' }, ro: { name: 'INDIVIDO Saperavi (0.75 L)', desc: 'Chateau Vartely • Vin roșu sec Saperavi • 0.750 L', tag: 'Individo Red' }, en: { name: 'INDIVIDO Saperavi (0.75 L)', desc: 'Chateau Vartely • Dry red Saperavi • 0.750 L', tag: 'Individo Red' } },
    { id: 'w8', category: 'alcohol', price: 200, ru: { name: 'INDIVIDO Merlot & Cabernet-Sauvignon (0.75 л)', desc: 'Chateau Vartely • Купаж Мерло и Каберне-Совиньон • 0.750 л', tag: 'Individo Red' }, ro: { name: 'INDIVIDO Merlot & Cabernet-Sauvignon (0.75 L)', desc: 'Chateau Vartely • Cupaj Merlot & Cabernet-Sauvignon • 0.750 L', tag: 'Individo Red' }, en: { name: 'INDIVIDO Merlot & Cabernet-Sauvignon (0.75 L)', desc: 'Chateau Vartely • Blend Merlot & Cabernet-Sauvignon • 0.750 L', tag: 'Individo Red' } },
    { id: 'w9', category: 'alcohol', price: 200, ru: { name: 'INDIVIDO Rară Neagră & Malbec - Syrah (0.75 л)', desc: 'Chateau Vartely • Купаж Рара Нягрэ, Мальбек и Сира • 0.750 л', tag: 'Individo Red' }, ro: { name: 'INDIVIDO Rară Neagră & Malbec - Syrah (0.75 L)', desc: 'Chateau Vartely • Cupaj Rară Neagră, Malbec & Syrah • 0.750 L', tag: 'Individo Red' }, en: { name: 'INDIVIDO Rară Neagră & Malbec - Syrah (0.75 L)', desc: 'Chateau Vartely • Blend Rară Neagră, Malbec & Syrah • 0.750 L', tag: 'Individo Red' } },
    { id: 'w10', category: 'alcohol', price: 200, ru: { name: 'INDIVIDO Fetească Neagră & Rară Neagră (0.75 л)', desc: 'Chateau Vartely • Красное сухое вино из автохтонных сортов • 0.750 л', tag: 'Individo Red' }, ro: { name: 'INDIVIDO Fetească Neagră & Rară Neagră (0.75 L)', desc: 'Chateau Vartely • Vin roșu sec din soiuri autohtone • 0.750 L', tag: 'Individo Red' }, en: { name: 'INDIVIDO Fetească Neagră & Rară Neagră (0.75 L)', desc: 'Chateau Vartely • Red dry wine native blend • 0.750 L', tag: 'Individo Red' } },

    // INDIVIDO WHITE & ROSE
    { id: 'w11', category: 'alcohol', price: 200, ru: { name: 'INDIVIDO Fetească Regală & Riesling (0.75 л)', desc: 'Chateau Vartely • Белое сухое вино • 0.750 л', tag: 'Individo White' }, ro: { name: 'INDIVIDO Fetească Regală & Riesling (0.75 L)', desc: 'Chateau Vartely • Vin alb sec • 0.750 L', tag: 'Individo White' }, en: { name: 'INDIVIDO Fetească Regală & Riesling (0.75 L)', desc: 'Chateau Vartely • Dry white wine • 0.750 L', tag: 'Individo White' } },
    { id: 'w12', category: 'alcohol', price: 200, ru: { name: 'INDIVIDO Traminer & Sauvignon Blanc (0.75 л)', desc: 'Chateau Vartely • Белое сухое вино • 0.750 л', tag: 'Individo White' }, ro: { name: 'INDIVIDO Traminer & Sauvignon Blanc (0.75 L)', desc: 'Chateau Vartely • Vin alb sec • 0.750 L', tag: 'Individo White' }, en: { name: 'INDIVIDO Traminer & Sauvignon Blanc (0.75 L)', desc: 'Chateau Vartely • Dry white wine • 0.750 L', tag: 'Individo White' } },
    { id: 'w13', category: 'alcohol', price: 200, ru: { name: 'INDIVIDO Malbec & Syrah Rosé (0.75 л)', desc: 'Chateau Vartely • Розовое сухое вино • 0.750 л', tag: 'Individo Rose' }, ro: { name: 'INDIVIDO Malbec & Syrah Rosé (0.75 L)', desc: 'Chateau Vartely • Vin rosé sec • 0.750 L', tag: 'Individo Rose' }, en: { name: 'INDIVIDO Malbec & Syrah Rosé (0.75 L)', desc: 'Chateau Vartely • Dry rosé wine • 0.750 L', tag: 'Individo Rose' } },
